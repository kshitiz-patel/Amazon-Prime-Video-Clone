...
if (isset($_POST) & !empty($_POST)) {
    $name = mysqli_real_escape_string($connection, $_POST["name"]); // 'x y z'
...
<html lang="en">
  <head>
    ...
    <title>Prime Video Sign-up</title>
  </head>
  <style>
    * {
  ...
  <body>
    <header class="showcase">
      <div class="showcase-top">
        ...
        <a href="./login.php" class="text-md">Login</a>
      </div>
